...
class Proxy(object):
    ...
    def __init__(self, proxy, fail_count=0, region="", anonymous="",
                 source="", check_count=0, last_status="", last_time="", https=False, ban=False, is_useable=True):
        self._proxy = proxy
    ...
    def createFromJson(cls, proxy_json):
        ...
        return cls(proxy=_dict.get("proxy", ""),
                   ...
                   ban=_dict.get("ban", False),
                   is_useable=_dict.get("is_useable", True),
                   )
    ...
    @is_useable.setter
    def is_useable(self,value):
        self._is_useable = value
